...
wisc_tweets = searchTwitter("Wisconsin", n=1500, lang="en")
...
wordcloud(wisc_clean, random.order = F, max.words = 50, scale = c(3, 0.5))

wordcloud(wisc_clean, random.order = F, max.words = 50, scale = c(3, 0.5), color = rainbow(50))
